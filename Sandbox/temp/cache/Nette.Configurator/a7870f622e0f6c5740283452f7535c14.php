<?php
// source: G:\xampp\htdocs\www\Sandbox\app/config/config.neon 
// source: G:\xampp\htdocs\www\Sandbox\app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			...
			'nette\\security\\iauthenticator' => array('nette.authenticator'),
			'nette\\security\\simpleauthenticator' => array('nette.authenticator'),
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => 'G:\\xampp\\htdocs\\www\\Sandbox\\app',
			'wwwDir' => 'G:\\xampp\\htdocs\\www\\Sandbox\\www',
			'debugMode' => TRUE,
			...
			'tempDir' => 'G:\\xampp\\htdocs\\www\\Sandbox\\app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('G:\\xampp\\htdocs\\www\\Sandbox\\app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	 ...
	 */
	public function createServiceNette__authenticator()
	{
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('G:\\xampp\\htdocs\\www\\Sandbox\\app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('G:\\xampp\\htdocs\\www\\Sandbox\\app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('G:\\xampp\\htdocs\\www\\Sandbox\\app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('G:\\xampp\\htdocs\\www\\Sandbox\\app/../temp/cache', $this->getService('nette.cacheJournal'));
	...
	{
		$service = new Nette\Security\User($this->getService('nette.userStorage'), $this->getService('nette.authenticator'));
